...
// CreateAccountLocation component for selecting country of origin
const LocationSelectionScreen = () => { // Changed to arrow function
      ...
      <div className="flex-grow overflow-y-auto space-y-3 pr-2 custom-scrollbar">
        {filteredCountries.length > 0 ? (
          filteredCountries.map((country) => (
            <div
              key={country.code} // Using country code as key for uniqueness
            ...
            >
              <div className="flex items-center space-x-3">
                {/* Flag image with onerror fallback */}
                <img
                  src={country.flag}
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = `https://placehold.co/32x24/F0F0F0/000000?text=${country.code}`; // Fallback placeholder
                  }}
                />
